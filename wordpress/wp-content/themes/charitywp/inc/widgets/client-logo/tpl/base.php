...
if ( $instance['image'] ) {
	...
	<div id="<?php echo esc_attr($client_logo_id) ?>" class="thim-client-logo" data-autoplay="<?php echo esc_attr($instance['autoPlay']); ?>" data-items="<?php echo esc_attr($instance['items']); ?>">
		<?php
			$i = 0;
